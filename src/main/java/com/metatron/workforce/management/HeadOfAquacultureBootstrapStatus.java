...
/** Internal evidence for the boot-time Head of Aquaculture reconciliation (same shape as the Gateway Director one). */
public final class HeadOfAquacultureBootstrapStatus {
