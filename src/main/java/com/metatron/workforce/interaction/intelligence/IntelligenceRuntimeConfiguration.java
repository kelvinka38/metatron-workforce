...
public class IntelligenceRuntimeConfiguration {
    ...
    InstitutionalIntelligenceRuntime institutionalIntelligenceRuntime(
            ...
            @Value("${METATRON_COGNITION_HTTP_TIMEOUT_MS:660000}") long cognitionHttpTimeoutMillis,
            ...
            @Value("${METATRON_COGNITION_QUEUE_WAIT_MS:660000}") long cognitionQueueWaitMillis,
            ObjectMapper objectMapper,
