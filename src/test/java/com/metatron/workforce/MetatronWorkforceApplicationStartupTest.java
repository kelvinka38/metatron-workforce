...
@SpringBootTest(
        ...
        properties = {
                ...
                "METATRON_WORKER_CONSTITUTION_RUNTIME_STATE_PATH=build/test-runtime/worker-constitution-runtime-state.json",
                "METATRON_WORKER_ACTOR_STATE_PATH=build/test-runtime/worker-actors",
